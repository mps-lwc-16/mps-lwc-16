...
extends the base language of MPS \comment{Federico: I understand what you mean by we should clarify this is not the BaseLanguage presents in MPS, which is basically Java}. The \emph{StateMachine} concept extends
